...
export default function RecyclingInfo({
  ...
  const hasShared =
    sharedRecyclingInfo?.raw && Object.keys(sharedRecyclingInfo.raw).length > 0;
    ...
    <div className="font-sans text-gray-900">
      <section className="py-16 px-6">
        <h2 className="text-2xl font-semibold text-center mb-8">
          Recycling Info by Region
        </h2>

        <div
          className="prose text-sm max-w-4xl mx-auto mb-10 text-center"
          data-hygraph-entry-id={entryId}
          data-hygraph-field-api-id="sharedRecyclingInfo"
        ...
        >
          {hasShared ? (
            ...
            <p className="text-gray-500 italic">
              No general recycling information available.
            </p>
          )}
        </div>
        <div
          ...
          data-hygraph-entry-id={entryId}
          data-hygraph-field-api-id="countryVariants"
          data-hygraph-entry-locale="en"
        >
          {countryVariants
